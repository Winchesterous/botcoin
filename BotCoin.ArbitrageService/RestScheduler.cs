...
namespace BotCoin.ArbitrageService
{
    internal class RestScheduler
    {
        ...
        private void OnTimerElapsed(object sender, ElapsedEventArgs e)
        {
            ...
            try
            {
                _tcpClient.InvokeServer(pair.Item2, new byte[] { (byte)pair.Item1 });
            }
        ...
        public void Connect(CurrencyName instrument)
        {
            ...
            lock (_obj)
            {
                ...
                _timer.Interval = _timeout / _connections.Count;
            }
